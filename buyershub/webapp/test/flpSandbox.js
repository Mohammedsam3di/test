					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Buyers Hub Innovation ",
									"targetURL": "#buyershub-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"buyershub-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=buyershub",
									"url": sap.ui.require.toUrl("buyershub")
								}
							}
						}
					}
